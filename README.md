...
# 概要:
</p>　本研究は、社会調査によってもたらされた質的データを、LocalWikiを用いてアーカイブする実践をもとに、その有効性と課題について考察するものである。実践に用いた調査記録には、筆者がタイ留学中の2019年1月から5月にかけて行った実地調査のフィールドノートを用いた。本実践の最たる目的は、調査記録に位置情報を結びつけ公開することで、「いつ・どこに・何が存在したか」あるいは「いつ・どこで情報を得られたか」という調査内容を証明することである。調査で得られた記録は文章のみならず画像や図表など多様であったが、同一のスポットで得られた情報は同一のページに記載することによって、一覧性と検索性の向上を図った。また、位置情報に関しては、実地調査時にも利用したMapillaryとOpenStreetMapを使用し、それらのリンクもLocalWikiに掲載した。
