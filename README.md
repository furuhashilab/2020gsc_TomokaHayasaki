...
# 概要:
</p>　本研究は、社会調査によってもたらされた質的データを、LocalWikiを用いてアーカイブした実践をもとに、その有効性と課題について考察するものである。実践に用いる調査記録として、筆者がタイ留学中の2019年1月から5月にかけて行った実地調査のフィールドノートを用いた。調査で得られた記録は文章のみならず画像やマッピングの記録など多様であったが、LocalWikiに位置別にひとまとめに記録することによって、アーカイブ化を図った。
