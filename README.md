...
</p>　実証研究において、その再現可能性を保証することは必須であるが、「いつ・どこに・何が存在したか」を証明するために、マッピングや位置情報に基づいた記録を行うことは有効であると言える。特にフィールドワークの手法の中でも、観察（あるいは参与観察）においてその有効性が認められる。今回は位置情報に基づく記述が可能であるLocalWikiを用いてアーカイブ化を図ったが、以下の点においてその利便性が顕著であった。第一に、フリーでオープンなツールであるために
